...
function Slide06Monetization() {
  ...
  return (
    <div className="slide-content">
      ...
      <p className="ed-lead">Не один поток дохода, а 10 — запускаются последовательно по фазам. Уже с первого дня MVP работают три потока.</p>
...
function SlideSWOT() {
  const swot = {
    ...
    threats: [
      ...
      { h: 'XPEL может запустить собственный маркетплейс', t: 'У XPEL 6 000 дилеров, $420M выручки, собственный DAP-портал. При желании они могут замкнуть цепочку "плёнка → установка → клиент" без Carreta.' },
